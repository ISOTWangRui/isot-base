...
deploy_file="mweb-server-bin.tar.gz"
...
export serverCtl=/home/jnapp/deploy/mweb-server
echo "   "
echo "###########################"
echo "####  restart mweb    #####"
echo "###########################"
echo "   "
echo "ServerId=mweb :" `ps -ef|grep 'ServerId=mweb' |grep -v "grep" |awk '{print $2}'`
ps -ef|grep 'ServerId=mweb' |grep -v "grep" |awk '{print $2}' |xargs kill -9
