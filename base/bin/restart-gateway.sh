...
deploy_file="gateway-server-bin.tar.gz"
...
export serverCtl=/home/jnapp/deploy/gateway-server
echo "   "
echo "###########################"
echo "####  restart gateway #####"
echo "###########################"
echo "   "
echo "ServerId=gateway :" `ps -ef|grep 'ServerId=gateway' |grep -v "grep" |awk '{print $2}'`
ps -ef|grep 'ServerId=gateway' |grep -v "grep" |awk '{print $2}' |xargs kill -9
